    ...
    public function paymentResponse()
    {
       ...
       $this->sessionStorage->getPlugin()->setValue('nnRedirectReinitiate', null);
        ...
        if(!empty($paymentResponseData['tid'])) {
            ...
            if($this->settingsService->getPaymentSettingsValue('novalnet_order_creation') != true && !isset($paymentResponseData['transaction']['order_no']) && empty($nnRedirectReinitiate) ) {
